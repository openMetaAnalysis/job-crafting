...
data.studies <- combine_esc(Gordon1, Gordon2)  
...
PlotName <- 'Emotional exhaustion reduction with\njob crafting vs control' 
...
meta::forest(data.meta, bylab =NULL, #sortvar = Year, 
             ...
             label.left = "Favors job crafting", 
